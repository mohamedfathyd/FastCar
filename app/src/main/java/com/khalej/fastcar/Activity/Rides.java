...
public class Rides extends AppCompatActivity {
    ...
    private RecyclerAdapter_rides recyclerAdapter;
    private List<My_Order> contactList = new ArrayList<>();
    ...
    public void fetchInfo(){
        ...
        Call<List<My_Order>> call = apiinterface.content_myOrder(sharedpref.getInt("id",0));
        call.enqueue(new Callback<List<My_Order>>() {
            @Override
            public void onResponse(Call<List<My_Order>> call, Response<List<My_Order>> response) {
                ...
                try {
                    ...
                    if(contactList.isEmpty()){
                        ...
                        recyclerAdapter = new RecyclerAdapter_rides(Rides.this, contactList);
            ...
            @Override
            public void onFailure(Call<List<My_Order>> call, Throwable t) {
                contactList=new ArrayList<>();
                progressBar.setVisibility(View.GONE);
